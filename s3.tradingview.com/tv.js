...
! function() {
    ...
    var o, i, r, n, a, s, d = "-apple-system, BlinkMacSystemFont, 'Trebuchet MS', Roboto, Ubuntu, sans-serif",
        l = {
            ...
            calculateWidgetHeight: function(t, e) {
                ...
                return r && e && (this.embedStylesForFullHeight(o + i, n, e), n) ? 100 + i : n ? "calc(" + o + i + " - 32px)" : o + i
            },
            onready: function(t) {
    ...
    l.WidgetAbstract.prototype = {
        ...
        addWrapperFrame: function(t) {
            ...
            return e.id = this.id + "-wrapper", e.style.cssText = "position: relative;box-sizing: content-box;margin: 0 auto !important;padding: 0 !important;font-family: " + d + ";", e.style.width = l.WidgetAbstract.prototype.width.call(this), e.style.height = l.WidgetAbstract.prototype.height.call(this), e.appendChild(t), e
        }
        ...
        render: function() {
            ...
            t.pathname = "/eventswidgetembed/", l.addUrlParams(t, {
            ...
            return e.title = l.getWidgetTitleAttribute(this.options.iframeTitle, this.widgetId), e.lang = this.options.iframeLang || "en", e.width = this.options.width, this.options.height && (e.height = this.options.height), e.setAttribute("frameBorder", "0"), e.setAttribute("scrolling", "no"), e.src = t, e
        }
        ...
        render: function() {
            ...
            this.options.customer && (i.pathname += this.options.customer + "/"), this.options.locale && i.searchParams.append("locale", this.options.locale), i.hash = encodeURIComponent(JSON.stringify(t));
        ...
        create: function() {
            ...
            var t = this;
            let e = this.iframe;
            this.options.noLogoOverlay || (e = l.WidgetAbstract.prototype.addWrapperFrame.call(this, e)), c(e, this.options);
        ...
        render: function() {
            ...
            return t.title = l.getWidgetTitleAttribute(this.options.iframeTitle, this.widgetId), t.lang = this.options.iframeLang || "en", t.id = this.id, t.style.cssText = "width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;", t.setAttribute("frameBorder", "0"), t.setAttribute("allowTransparency", "true"), t.setAttribute("scrolling", "no"), t.setAttribute("allowfullscreen", "true"), t.src = this.generateUrl(), t
        },
        generateUrl: function(t) {
            ...
            function o(t, e, o) {
                let i = h(e, o);
                "object" == typeof i && (i = JSON.stringify(i)), void 0 !== i && "" !== i && (a[t] = i)
            }
            ...
            const n = new URL(r + e);
            n.searchParams.append("hideideas", "1"), n.searchParams.append("overrides", JSON.stringify(h(t.overrides, {}))), n.searchParams.append("enabled_features", JSON.stringify(h(t.enabled_features, []))), n.searchParams.append("disabled_features", JSON.stringify(h(t.disabled_features, []))), t.locale && n.searchParams.append("locale", t.locale);
            const a = Object.create(null);
            return a.symbol = t.symbol, a.frameElementId = this.id, a.interval = t.interval, o("range", t.range), i("hide_top_toolbar", t.hide_top_toolbar), i("hide_legend", t.hide_legend), i("hide_side_toolbar", t.hide_side_toolbar, "0"), i("allow_symbol_change", t.allow_symbol_change, "0"), i("save_image", t.save_image, "0"), i("doNotStoreSettings", t.doNotStoreSettings), o("backgroundColor", t.backgroundColor), o("gridColor", t.gridColor), t.watchlist && t.watchlist.length && t.watchlist.join && o("watchlist", t.watchlist.join("")), i("editablewatchlist", t.editablewatchlist), i("details", t.details), i("calendar", t.calendar), i("hotlist", t.hotlist), t.studies && l.isArray(t.studies) && ("string" == typeof t.studies[0] ? o("studies", t.studies.join("")) : o("studies", t.studies)), i("horztouchdrag", t.horztouchdrag, "0"), i("verttouchdrag", t.verttouchdrag, "0"), o("widgetbar_width", t.widgetbar_width), o("theme", t.theme), o("style", t.style), o("extended_hours", t.extended_hours), o("timezone", t.timezone), i("hideideasbutton", t.hideideasbutton), i("withdateranges", t.withdateranges), i("hide_volume", t.hide_volume), o("padding", t.padding), i("show_popup_button", t.show_popup_button), o("padding", t.padding), o("studies_overrides", t.studies_overrides, {}), o("publish_source", t.publish_source), i("enable_publishing", t.enable_publishing), o("venue", t.venue), o("symbology", t.symbology), o("whotrades", t.whotrades), o("referral_id", t.referral_id), i("no_referral_id", t.no_referral_id), o("fundamental", t.fundamental), o("percentage", t.percentage), o("utm_source", window.location.hostname), o("utm_medium", l.hasCopyright(t.container) ? "widget_new" : "widget"), o("utm_campaign", t.type), r !== l.host && o("supportHost", l.host), t.type && "chart" === t.type && o("utm_term", t.symbol), o("page-uri", l.getPageUriString()), `${n}#${encodeURIComponent(JSON.stringify(a))}`
        },
        image: function(t) {
        ...
        create: function() {
            ...
            var o, i = this;
            c(e, this.options), o = document.getElementById(this.id), l.bindEvent(o, "load", (function() {
                var t;
        ...
        render: function() {
            ...
            }, !0), this.options.type = "chart", l.addUrlParams(t, l.generateUtmForUrlParams(this.options));
            const e = document.createElement("iframe");
            return e.title = l.getWidgetTitleAttribute(this.options.iframeTitle, this.widgetId), e.lang = this.options.iframeLang || "en", e.id = this.id, e.style.cssText = "width: 100%; height: 100%; margin: 0 !important; padding: 0 !important;", e.setAttribute("frameBorder", "0"), e.setAttribute("allowTransparency", "true"), e.setAttribute("scrolling", "no"), e.setAttribute("allowfullscreen", "true"), e.src = t.href, e
        },
    ...
    }, l.postMessageWrapper = (i = {}, r = {}, n = {}, a = 0, s = 0, window.addEventListener && window.addEventListener("message", (function(t) {
        var e;
        try {
            e = JSON.parse(t.data)
        } catch (t) {
        ...
        if (e && e.provider && "TradingView" === e.provider)
            ...
            } else if ("on" === e.type) i[e.client_id] && i[e.client_id][e.id] && (i[e.client_id][e.id].call(e, e.data), delete i[e.client_id][e.id]);
        else if ("post" === e.type) {
            if (!r[e.name]) return;
            r[e.name].forEach((function(t) {
        ...
        for (var t = /\+/g, e = /([^&=]+)=?([^&]*)/g, o = window.location.search.substring(1), i = e.exec(o), r = function(e) {
            ...
            }, n = {}; i;) n[r(i[1])] = r(i[2]), i = e.exec(o);
        return n
    }, l.createUrlParams = function(t) {
        var e = [];
        for (var o in t) t.hasOwnProperty(o) && null != t[o] && e.push(encodeURIComponent(o) + "=" + encodeURIComponent(t[o]));
        return e.join("&")
        ...
        if (o) {
            ...
            if (i) {
                ...
                if (r) {
                    ...
                    if (n) try {
                        const t = new URL(n);
                        l.addUrlParams(t, l.generateUtmForUrlParams(e)), r.setAttribute("href", t.toString())
                    } catch (t) {
                        console.log(`Cannot update link UTM params, href="${n}"`)
                    }
                }
            }
        } else document.currentScript.parentNode.insertBefore(t, document.currentScript.nextSibling);
    ...
    window.TradingView ? function t(e, o) {
        for (var i in o) "object" == typeof o[i] && e.hasOwnProperty(i) ? t(e[i], o[i]) : e[i] = o[i];
        return e
